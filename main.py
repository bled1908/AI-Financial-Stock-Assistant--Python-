    ...
    },
    {
        ...
        'parameters': {
            ...
            'properties': {
                ...
                'window': {
                    'type': 'integer',
                    'description': 'The window size for the SMA calculation (e.g., 20 for a 20-day SMA). The timeframe to consider when calculating the SMA.'
                }
            },
    ...
    },
    {
        ...
        'parameters': {
            ...
            'properties': {
                ...
                'window': {
                    'type': 'integer',
                    'description': 'The window size for the EMA calculation (e.g., 20 for a 20-day EMA). The timeframe to consider when calculating the EMA.'
                }
            },
            'required': ['ticker', 'window'],
        },
